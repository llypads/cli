...
Copied from https://github.com/michailbrynard/ethereum-bip44-python
"""
import math
import base58
import base64
...
class PrivateKeyBase(object):
    ...
    def to_b58check(self, testnet=True):
...
class PublicKey(PublicKeyBase):
    ...
    @staticmethod
    def from_base64(b64str, testnet=True):
...
class HDKey(object):
    ...
    def _serialize(self, testnet=True):
        version = self.TESTNET_VERSION if testnet else self.MAINNET_VERSION
